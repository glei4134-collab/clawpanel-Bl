...
// 晴辰云（已移除，保留空壳防编译报错）
export const QTCOOL = { baseUrl: '', defaultKey: '', site: '', checkinUrl: '', usageUrl: '', providerKey: 'qtcool', brandName: '', api: 'openai-completions', models: [] }
export async function fetchQtcoolModels() { return [] }
