...
export default {
  ...
  copyright: _('MIT License', 'MIT License'),
  ...
  hotUpdate: _('热更新', 'Hot Update', '熱更新', 'ホットアップデート', '핫アップデート'),
  ...
  domesticMirrorHint: _('镜像：<a href="https://github.com/openclaw" target="_blank" rel="noopener" style="color:var(--accent)">GitHub</a>', 'Mirror: <a href="https://github.com/openclaw" target="_blank" rel="noopener" style="color:var(--accent)">GitHub</a>'),
  companyName: _('ClawPanel', 'ClawPanel'),
  ...
  companyDesc: _('OpenClaw Management Panel', 'OpenClaw Management Panel'),
